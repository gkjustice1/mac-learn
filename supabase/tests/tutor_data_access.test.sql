...
-- authenticated table SELECT on tutor_profiles. This suite needs SELECT only
-- to exercise the existing RLS visibility policies; rollback removes the grant.
...
('85000000-0000-4000-8000-000000000001','75000000-0000-4000-8000-000000000001','65000000-0000-4000-8000-000000000001','55000000-0000-4000-8000-000000000001',now()-interval '2 hours',now()-interval '1 hour'),
