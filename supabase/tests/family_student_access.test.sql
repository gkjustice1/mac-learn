...
values ('64000000-0000-4000-8000-000000000001', '14000000-0000-4000-8000-000000000001', 'Legacy Parent', 'family-access@example.test', '24000000-0000-4000-8000-000000000001');
...
insert into public.guardian_student_relationships (organization_id, guardian_id, student_id, relationship_type, educational_access, valid_from, valid_until) values
...
select is((select count(*) from public.students where id = '74000000-0000-4000-8000-000000000003'), 0::bigint, 'a relationship without educational access overrides the legacy parent link');
